    ...
    return {
      ...
      roles: [
        ...
        },
        {
          id: 2,
          name: 'Médico',
          description: 'Acesso a registos médicos e agendamentos',
          type: 'department',
          hierarchy: 'Medicina',
          userCount: 25,
          permissionCount: 18,
        ...
        },
        {
          id: 3,
          name: 'Enfermeiro',
          description: 'Acesso limitado a registos e cuidados',
          type: 'department',
          hierarchy: 'Enfermagem',
          userCount: 45,
          permissionCount: 12,
          active: true
        },
        {
          id: 4,
          name: 'Rececionista',
          description: 'Gestão de agendamentos e informações básicas',
          type: 'custom',
          hierarchy: 'Administração',
          userCount: 8,
          permissionCount: 6,
        ...
        },
        {
          id: 5,
          name: 'Convidado',
          description: 'Acesso apenas de leitura limitado',
          type: 'system',
          hierarchy: '',
          userCount: 12,
          permissionCount: 3,
      ...
      modules: [
        {
          ...
          permissions: [
            { id: 1, name: 'Criar Utilizador', description: 'Adicionar novos utilizadores', critical: false },
            { id: 2, name: 'Editar Utilizador', description: 'Modificar dados de utilizadores', critical: false },
            { id: 3, name: 'Eliminar Utilizador', description: 'Remover utilizadores do sistema', critical: true },
            { id: 4, name: 'Ver Utilizadores', description: 'Visualizar lista de utilizadores', critical: false }
          ]
        },
        {
          id: 2,
          name: 'Registos Médicos',
          permissions: [
            { id: 5, name: 'Criar Registo', description: 'Criar novos registos médicos', critical: false },
            { id: 6, name: 'Editar Registo', description: 'Modificar registos existentes', critical: true },
            { id: 7, name: 'Ver Registos', description: 'Visualizar registos médicos', critical: false },
            { id: 8, name: 'Eliminar Registo', description: 'Remover registos médicos', critical: true }
          ]
        },
        {
          id: 3,
          name: 'Agendamentos',
          permissions: [
            { id: 9, name: 'Criar Agendamento', description: 'Agendar consultas', critical: false },
            { id: 10, name: 'Editar Agendamento', description: 'Modificar agendamentos', critical: false },
            { id: 11, name: 'Cancelar Agendamento', description: 'Cancelar consultas agendadas', critical: false },
            { id: 12, name: 'Ver Agenda', description: 'Visualizar calendário de consultas', critical: false }
          ]
        },
        {
          id: 4,
          name: 'Relatórios',
          permissions: [
            { id: 13, name: 'Gerar Relatórios', description: 'Criar relatórios do sistema', critical: false },
            { id: 14, name: 'Exportar Dados', description: 'Exportar informações', critical: true },
            { id: 15, name: 'Ver Estatísticas', description: 'Visualizar métricas', critical: false }
          ]
        },
        {
          id: 5,
          name: 'Configurações',
          permissions: [
            { id: 16, name: 'Configurar Sistema', description: 'Alterar configurações gerais', critical: true },
            { id: 17, name: 'Gerir Permissões', description: 'Administrar permissões', critical: true },
            { id: 18, name: 'Backup/Restore', description: 'Operações de backup', critical: true }
          ]
        },
        {
          id: 6,
          name: 'Financeiro',
          permissions: [
            { id: 19, name: 'Ver Faturação', description: 'Visualizar faturas', critical: false },
            { id: 20, name: 'Processar Pagamentos', description: 'Gerir pagamentos', critical: true },
            { id: 21, name: 'Relatórios Financeiros', description: 'Gerar relatórios financeiros', critical: false }
          ]
        }
      ],
      ...
      abacRules: [
        {
          id: 1,
          name: 'Acesso a Registos por Departamento',
          description: 'Médicos só podem aceder a registos do seu departamento',
          subject: 'user.role',
          resource: 'medical.records',
          action: 'read',
          conditions: [
            { id: 1, attribute: 'user.department', operator: 'equals', value: 'resource.department' },
            { id: 2, attribute: 'user.active', operator: 'equals', value: 'true' }
          ],
          active: true
        },
        {
          ...
          description: 'Acesso limitado fora do horário de trabalho',
          subject: 'user.role',
          resource: 'system.access',
          action: 'login',
          conditions: [
            { id: 3, attribute: 'current.time', operator: 'greater_than', value: '08:00' },
            { id: 4, attribute: 'current.time', operator: 'less_than', value: '18:00' }
          ],
          active: true
        },
        {
          id: 3,
          name: 'Acesso Crítico por Senioridade',
          description: 'Operações críticas requerem senioridade mínima',
          subject: 'user.role',
          resource: 'critical.operations',
          action: 'execute',
          conditions: [
            { id: 5, attribute: 'user.experience_years', operator: 'greater_than', value: '2' },
            { id: 6, attribute: 'user.certification', operator: 'equals', value: 'valid' }
          ],
          active: true
        }
      ],
          ...
          children: [
            {
              ...
              userCount: 35,
              children: [
                { id: 3, name: 'Equipa A', type: 'team', userCount: 12 },
                { id: 4, name: 'Equipa B', type: 'team', userCount: 15 },
                { id: 5, name: 'Equipa C', type: 'team', userCount: 8 }
              ]
            },
            {
              id: 6,
              ...
              userCount: 28,
              children: [
                { id: 7, name: 'Cirurgia Geral', type: 'team', userCount: 15 },
                { id: 8, name: 'Cirurgia Cardíaca', type: 'team', userCount: 13 }
              ]
            },
            {
              id: 9,
              ...
              userCount: 65,
              children: [
                { id: 10, name: 'Enfermagem Geral', type: 'team', userCount: 25 },
                { id: 11, name: 'Cuidados Intensivos', type: 'team', userCount: 20 },
                { id: 12, name: 'Pediatria', type: 'team', userCount: 20 }
              ]
            },
            {
              id: 13,
              ...
              userCount: 22,
              children: [
                { id: 14, name: 'Recursos Humanos', type: 'team', userCount: 8 },
                { id: 15, name: 'Financeiro', type: 'team', userCount: 6 },
                { id: 16, name: 'TI', type: 'team', userCount: 8 }
              ]
            }
          ]
        }
